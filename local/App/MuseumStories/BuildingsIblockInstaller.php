...
class BuildingsIblockInstaller
{
  ...
  public function install(array $siteIds = []): array
  {
    ...
    $existingIblock = $this->findExistingIblock(MuseumStoriesConfig::IBLOCK_CODE);
      ...
      if ($iblockId <= 0) {
        ...
        if ($iblockId <= 0) {
          ...
          return [
            ...
            'id' => null,
            'errors' => [
              Loc::getMessage('APP_MUSEUM_STORIES_IBLOCK_CREATE_ERROR'),
  ...
  private function buildIblockFields(array $siteIds): array
  {
    return [
      'ACTIVE' => 'Y',
      'NAME' => MuseumStoriesConfig::IBLOCK_NAME,
      'CODE' => MuseumStoriesConfig::IBLOCK_CODE,
      'API_CODE' => MuseumStoriesConfig::IBLOCK_API_CODE,
      'IBLOCK_TYPE_ID' => MuseumStoriesConfig::IBLOCK_TYPE_ID,
      'SITE_ID' => $siteIds,
      'SORT' => 500,
      'VERSION' => 2,
      'DESCRIPTION' => MuseumStoriesConfig::IBLOCK_DESCRIPTION,
  ...
  private function ensureProperties(int $iblockId): array
  {
    ...
    foreach ($this->getPropertyDefinitions() as $propertyFields) {
      ...
      if ($propertyId <= 0) {
        $errors[] = Loc::getMessage('APP_MUSEUM_STORIES_IBLOCK_PROPERTY_CREATE_ERROR');
  ...
  /**
   * Возвращает список свойств для инфоблока зданий.
   *
  ...
  private function getPropertyDefinitions(): array
  {
    return [
      ...
      [
        'NAME' => 'Адрес',
        'CODE' => MuseumStoriesConfig::PROPERTY_ADDRESS_RU,
        'ACTIVE' => 'Y',
        'SORT' => 200,
        'PROPERTY_TYPE' => 'S',
      ],
      [
        ...
        'CODE' => MuseumStoriesConfig::PROPERTY_MAP_COORDS,
        'ACTIVE' => 'Y',
        'SORT' => 300,
        'PROPERTY_TYPE' => 'S',
      ],
      [
        'NAME' => 'Закрыто',
        'CODE' => MuseumStoriesConfig::PROPERTY_CLOSED_FLAG,
        'ACTIVE' => 'Y',
        'SORT' => 400,
        'PROPERTY_TYPE' => 'L',
        'VALUES' => [
      ...
      [
        ...
        'CODE' => MuseumStoriesConfig::PROPERTY_TICKET_URL,
        'ACTIVE' => 'Y',
        'SORT' => 500,
        'PROPERTY_TYPE' => 'S',
      ],
      [
        ...
        'CODE' => MuseumStoriesConfig::PROPERTY_PICTURE_PATH,
        'ACTIVE' => 'Y',
        'SORT' => 600,
        'PROPERTY_TYPE' => 'S',
      ],
      [
        'NAME' => 'Таймлайн',
        'CODE' => MuseumStoriesConfig::PROPERTY_TIMELINE_RU,
        'ACTIVE' => 'Y',
        'SORT' => 700,
        'PROPERTY_TYPE' => 'S',
      ],
